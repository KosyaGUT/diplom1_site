...
SECRET_KEY = 'django-insecure-4pzn#ph2!bkb+(vwpfr$!qb7$gm2#)0^iauynn!@zr&p8^3_*9'
...
INSTALLED_APPS = [
    ...
    'ckeditor', # Библиотека для редактирования текста сразу
    'ckeditor_uploader',
...
USE_TZ = True  # Включаем использование часового пояса
...
CKEDITOR_UPLOAD_PATH = "/media/"  # Путь для хранения изображений
